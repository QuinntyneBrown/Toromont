...
- Name: equipment.spec.ts >> Equipment List >> search filters equipment by name
- Location: tests\equipment.spec.ts:52:7
...
Call log:
  - waiting for locator('[data-testid="equipment-search"]')
