...
- Name: work-orders.spec.ts >> Work Orders - Mobile >> mobile status tabs are scrollable
- Location: tests\work-orders.spec.ts:127:7
...
Locator: locator('[data-testid="status-tabs"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="status-tabs"]')
