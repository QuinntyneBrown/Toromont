...
- Name: ai-insights.spec.ts >> AI Insights Dashboard >> anomaly alerts panel shows alerts with details
- Location: tests\ai-insights.spec.ts:48:7
...
Locator: locator('[data-testid="anomaly-alerts"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="anomaly-alerts"]')
