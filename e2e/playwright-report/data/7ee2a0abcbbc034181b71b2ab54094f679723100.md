...
- Name: work-orders.spec.ts >> Service Calendar >> displays calendar with work orders
- Location: tests\work-orders.spec.ts:140:7
...
Locator: locator('[data-testid="service-calendar"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="service-calendar"]')
