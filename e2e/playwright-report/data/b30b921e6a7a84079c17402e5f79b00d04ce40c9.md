...
- Name: ai-insights.spec.ts >> AI Insights Dashboard >> displays predictions in a sortable grid
- Location: tests\ai-insights.spec.ts:13:7
...
Locator: locator('[data-testid="predictions-grid"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="predictions-grid"]')
